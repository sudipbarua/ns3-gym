...
NS_LOG_COMPONENT_DEFINE("AiAdrLog");
...
main(int argc, char* argv[])
{
    ...
    LogComponentEnable("AiAdrLog", LOG_LEVEL_ALL);
    ...
    **********************************************************************************************************/
    ...
    DeviceEnergyModelContainer deviceModels = radioEnergyHelper.Install(endDevicesNetDevices, ergSources);
